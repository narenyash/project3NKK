...
def process_essays(model_name):
    """Process all essay files and create hybrid versions."""
    
    # Get all Tab_*.txt files
    essay_files = sorted(
    ...
    if not essay_files:
        print("No essay files found in class H folder!")
        return
    ...
    print(f"Files follow the pattern: Tab_X_hybrid.txt")

if __name__ == "__main__":
    print("\n" + "="*60)
    print("HYBRID ESSAY GENERATOR WITH LOCAL OLLAMA")
    print("="*60 + "\n")
